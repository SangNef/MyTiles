        ...
        <div className="about-content">
          <div className="description">
            ...
            <div className="content">
              ...
              <p>
                ...
                Tiles, We Have Something For Everyone. We Also Offer
                Installation Services, So You Can Have Your New Tiles Installed
                With Confidence By Our Team Of Professionals.
              </p>
              <p>
                Thank You For Choosing Wall Tiles Shop. We Look Forward To
                Working With You And Helping You Transform Your Space With
                Beautiful, Durable Tiles.
              </p>
          ...
          <div className="who-we-are">
            ...
            <div className="content">
              <h3>WHO WE ARE</h3>
              <p>
                MyTiles was established in 2001 by a group of friends who share
                the same passion in tiles.
              </p>{" "}
              <br />
              <p>
              ...
              <p>
                – At 14 subsidiaries worldwide, three of which located in the
                USA;
              </p>{" "}
              <br />
              <p>
                – Creating a domestic distribution network with 14 warehouses
                and over 3000 agents across Vietnam.
              </p>{" "}
              <br />
              <p>
                – Exported to over 14 countries in the world (USA, Taiwan,
